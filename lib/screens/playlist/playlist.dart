...
class _PlayListsState extends State<PlayLists> {
  ...
  String selectedPlaylistTitle = 'Playlist';
  ...
  Widget _buttonBar(context, List<PlaylistTitle> data, index) {
    ...
    // selectedPlaylistTitle = data[index].title;
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
                            ...
                            return Consumer<PlayListProvider>(
                              builder:
                                ...
                                return TextButton(
                                    ...
                                    //  dropDownProvider.setPlaylist(data[index]);
                                      setState(() {
                                        selectedPlaylistTitle =
                                            data[index].title;
                                        selectedPlaylistId =
          ...
          selectedPlaylistTitle == 'Playlist'? Container():
          Padding(
                ...
                showDialog(
                    ...
                    builder: (context) {
                      return AlertDialog(
                        backgroundColor: kPrimaryColor,
                        title: const Text(
                          'Musics under this playlist will also be deleted',
                                 ...
                                 // var id = selectedPlaylistId;
                                  ...
                                  setState(() {
                                    context
                                        ...
                                        .deletePlaylistTitle(selectedPlaylistId);
                                    selectedPlaylistTitle = 'Playlist';
                                  });
                                  Navigator.of(context).pop();
                                  ScaffoldMessenger.of(context).showSnackBar(
                                      const SnackBar(
...
//                       elevation: 2,
//                       automaticallyImplyLeading: false,
//                       title: const Text('My PlayList',style: TextStyle(color: kSecondaryColor),),
//                       flexibleSpace: FlexibleSpaceBar(
//                         background: Stack(
//                           fit: StackFit.expand,
//                           children: [
