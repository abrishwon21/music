      ...
      builder: (context, isPlaying) {
        return Column(
          children: [
            GestureDetector(
              onTap: () {
                p.setBuffering(episodeIndex,episode.id);
                              ...
                              Row(
                                  ...
                                  children: [
                                    ...
                                    p.currentEpisode == null
                                        ? Container(): !p.isEpisodeLoaded
                                        &&p.tIndex == episodeIndex && podCast.episodes[p.tIndex].id == p.bufferingEpisodeId
                                        ? SizedBox(
                                      height: 30,
                                      width: 30,
